...
import org.cvn.videoplayer.ui.movie.presenter.MoviePresenter;
import org.cvn.videoplayer.ui.movie.view.activity.MovieNewsActivity;
import org.cvn.videoplayer.ui.movie.view.adapter.MovieBannerAdapter;
...
import org.cvn.videoplayer.ui.movie.view.adapter.MovieAdapter;
import org.cvn.videoplayer.ui.movie.view.activity.MovieDetailActivity;
import org.cvn.videoplayer.ui.test.test4.MediaPlayerActivity;
...
public class MovieFragment extends BaseFragment implements MovieContract.View{
    ...
    public void setAdapterData(MovieBean movieBean) {
        LogUtils.i("MovieFragment msg==>"+movieBean.getMsg());
        ...
        LogUtils.i("MovieFragment list==>"+list.size());
        ...
        LogUtils.i("MovieFragment movieList"+movieList.size());
        if(movieList.size()>0){
            adapter.clear();
