package org.cvn.videoplayer.ui.home.view.fragment;
...
import org.cvn.videoplayer.ui.home.view.adapter.BannerPagerAdapter;
import org.cvn.videoplayer.ui.main.view.activity.MainActivity;
import org.cvn.videoplayer.ui.test.test2.TestMyActivity;
import org.cvn.videoplayer.util.AppUtil;
import org.cvn.videoplayer.util.ImageUtil;
import org.cvn.videoplayer.util.LogUtils;
import org.cvn.videoplayer.R;
import org.cvn.videoplayer.base.BaseDelegateAdapter;
    ...
    private void initListFirstView() {
        ...
        BaseDelegateAdapter adapter = new BaseDelegateAdapter(activity, gridLayoutHelper, R.layout.view_vlayout_grid, 4, Constant.viewType.typeGv) {
            ...
            public void onBindViewHolder(BaseViewHolder holder, final int position) {
                super.onBindViewHolder(holder, position);
                int space=position % 2 == 1 ? 0: AppUtil.dip2px(6);
                holder.getView(R.id.ll_item).setPadding(space,0,AppUtil.dip2px(6),0);
                ...
                holder.getView(R.id.ll_item).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        startActivity(VideoPlayerMeActivity.class,bundle);
                    }
                });
            }
        };
    ...
    private void initTitleView(final int type) {
        BaseDelegateAdapter titleAdapter = new BaseDelegateAdapter(activity, new LinearLayoutHelper(), R.layout.view_vlayout_title, 1, Constant.viewType.typeTitle) {
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                ...
                switch (type) {
                    case 1:
                        holder.setText(R.id.tv_title, "精选视频");
                        break;
                    case 2:
                        holder.setText(R.id.tv_title, "最热电影");
                        break;
                    case 3:
                        holder.setText(R.id.tv_title, "影视排行");
                        break;
                    case 4:
                        holder.setText(R.id.tv_title, "综艺节目");
                        break;
                    case 5:
                        holder.setText(R.id.tv_title, "热点新闻");
                        break;
                    case 6:
